...
//            showFlag(a.getBoolean(R.styleable.CountryCodePicker_ccp_showFlag, true));
            showFlag(a.getBoolean(R.styleable.CountryCodePicker_ccp_showFlag, false));
            ...
            if (isInEditMode()) {
                ...
                contentColor = a.getColor(R.styleable.CountryCodePicker_ccp_contentColor, context.getResources().getColor(R.color.white));
            }
            if (contentColor != 0) {
