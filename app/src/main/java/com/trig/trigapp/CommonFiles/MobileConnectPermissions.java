...
public class MobileConnectPermissions {
    private static final String TAG = MobileConnectPermissions.class.getSimpleName();
    ...
    public static void init(Context context) {
        sharedPreferences = context.getSharedPreferences("pl.acs.runtimepermissionhelper", Context.MODE_PRIVATE);
        MobileConnectPermissions.context = context;
    }
...
//    }
    ...
    public static boolean checkPermission(String permissionName) {
        if (context == null) {
            throw new RuntimeException("Before comparing permissions you need to call MobileConnectPermissions.init(context)");
        }
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
